...
if __name__ == "__main__":
    ...
    for i in range(start_num, image_num):
        ...
        norm_img[start_h : start_h + h, start_w : start_w + w, :] = img
        norm_img_conts[start_h : start_h + h, start_w : start_w + w, :] = img_conts
        ...
        for ci, contour in enumerate(contours_list):                
            ...
            norm_img_cont[start_h : start_h + h, start_w : start_w + w, :] = img_cont
